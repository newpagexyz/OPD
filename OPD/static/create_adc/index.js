     ...
     methods: {
      ...
      handleSubmit: function(){
         var form = new FormData(document.getElementById('adc-form'));
              ...
              console.log(form.get('resolution'));
              //              console.log('https://adc.newpage.xyz/api/add_adc/?session='+this.session+'&token='+this.token+'&model='+form.get('model')== ''? 0:form.get('model')+'&description='+form.get('description') == ''? 0: form.get('description') +'&resolution='+form.get('resolution')== ''? 0: form.get('resolution') +'&channels='+form.get('channels')== ''? 0: form.get('channels') +'&max_sample_rate='+form.get('max_sample_rate')== ''? 0: form.get('max_sample_rate') +'&interface='+this.getKeyByValue(this.Interfaces,form.get('interface'))== ''? 0: this.getKeyByValue(this.Interfaces,form.get('interface')) +'&arch='+this.getKeyByValue(this.Arches,form.get('arch'))== ''? 0: this.getKeyByValue(this.Arches,form.get('arch')) +'&max_INL='+form.get('max_INL')== ''? 0: form.get('max_INL') +'&SNR='+form.get('SNR')== ''? 0: form.get('SNR') +'&SFDR='+form.get('SFDR')== ''? 0: form.get('SFDR') +'&power='+form.get('power')== ''? 0: form.get('power') +'&temperature='+form.get('temperature')== ''? 0: form.get('temperature') +'&analog_input='+form.get('analog_input')== ''? 0:  form.get('analog_input')+'&FoMW='+form.get('FoMW')== ''? 0 : form.get('FoMW')+'&max_DNL='+form.get('max_DNL')== ''? 0: form.get('max_DNL'));
